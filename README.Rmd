...
4. Copy [these two lines]((https://github.com/mlr3learners/mlr3learners.extratrees/blob/master/appveyor.yml#L35-L36)) as env var "id_rsa" into your `appveyor.yml` file.

5. Now go to Travis CI (org) (`travis::browse_travis(endpoint = ".org")`) and delete the "id_rsa" env var.
   ...
   1. Create a new SSH key pair. Add the private key as a secure env var "id_rsa" to Travis CI for your repo. 
